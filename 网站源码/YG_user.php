        ...
        <div class="con_right">
        	<div class="user_info">
            	...
            	<div style="width:100px; height:100px; border-radius:50px; overflow:hidden;">
                	...
                	<img src="<? echo $result_arr["head_tx"]; ?>" alt="<? echo $_SESSION["user"]?>" style="height:100px; width:100px; overflow:hidden; vertical-align:middle;">
                    <? }else{?>
                    <img src="" alt="..." style="height:100px; width:100px; overflow:hidden; vertical-align:middle;">
                    <? }?>
                 </div>   
                <ul>
