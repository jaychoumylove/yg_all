...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".T_n_o .jia").click(function(){
			...
			if(num==0){return;}
			if(num>$("#stock").val()){return;  n=$("#stock").val();}
			$(this).prev().val(num);
		})
		//加的效果 end
		//减的效果 start
		$(".T_n_o .jian").click(function(){
			...
			if(nun==0){return;}
			if(nun>$("#stock").val()){return; m=$("#stock").val();}
            ...
            <div class="sales">
                ...
                <ul class="shopping">
                    <li class="T_n_o">
                        ...
                        <a class="jia">+</a>
                        <a class="jian">-</a>
                        <input type="hidden" value="<? echo $result_arr["stock"]-$result_arr["sales_vol"];?>" id="stock" />
                    </li>
