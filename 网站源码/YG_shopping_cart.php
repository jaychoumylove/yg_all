...
<body>
    	...
    	<div class="m_content">
            ...
            <form method="post" action="YG_ACK.php">
                <table>
                    ...
                    <tbody>
						...
						<?	}else{
								...
								$heji=0.00;
								$shoppingcart_Id_arr=array();
								$shoppingcart_much_arr=array();
								for($i=0;$i<count($shopping_cart_Id_arr);$i++){
									...
									if($act=="changenum"){
										if($Id==$shopping_cart_Id_arr[$i]){
											...
											array_push($shoppingcart_much_arr,$shopping_cart_much_arr[$i]);
										}else{
											$shopping_cart_much_arr[$i]=$shopping_cart_much_arr[$i];
											array_push($shoppingcart_much_arr,$shopping_cart_much_arr[$i]);
										}
									}else{
										$shopping_cart_much_arr[$i]=$shopping_cart_much_arr[$i];
                        ...
                        <tr>
                            ...
                            <td class="many_box">
                                <!--<a class="jian">-</a>-->
                                <input type="text" value="<? echo $shopping_cart_much_arr[$i] ?>" onChange="window.location.href='YG_shopping_cart.php?act=changenum&Id=<? echo $result_arr["Id"]?>&prdnum='+this.value" disableautocomplete="" autocomplete="off" />
                                <!--<a class="jia">+</a>   -->                             
                            </td>
                            ...
                            <td class="orn_box">
                                ...
                                <p><a href="collection_deal.php?act=add&pro_Id=<? echo $result_arr["Id"]?>&gwc=gwc" target="_self">移到我的收藏</a></p>
                            </td>
                        </tr>
                        <? 
							array_push($shoppingcart_Id_arr,$shopping_cart_Id_arr[$i]);
							}
							$shopping_cart_Id_str=implode(",",$shoppingcart_Id_arr);
							$_SESSION["shopping_cart_Id"]=$shopping_cart_Id_str;
							$shopping_cart_much_str=implode(",",$shoppingcart_much_arr);
                ...
                <!--<ul class="page">
                    ...
                    <li class="now_page">2&nbsp;/&nbsp;3</li>
                    <li><a href="#" target="_self">下一页</a></li>
                    <li><a href="#" target="_self">尾页</a></li>
                    <li><input type="text" class="pg_it" name="" id="" value=""/></li>
                    <li><input type="submit" class="pg_st" value="转到"/></li>
                </ul>-->
        		<div class="space_hx"></div>
                <ul class="S_order">
                	<li><input type="checkbox" checked="false" id="checkall" name="checkall" value="全选" /><span class="all_n">全选</span>&nbsp;&nbsp;&nbsp;</li>
                	<!--<li><input type="button" id="check_revsern" class="" name="check_revsern" value="反选" /></li>-->
                	<!--<li><span class="del_sel">删除所选商品</span></li>-->
                    <li><span class="del_sel"><a href="shopping_cart_deal.php?act=clear">清空购物车</a></span></li>
                    <!--<li><a href="#" target="_self">将所选商品移到我的收藏</a></li>-->
            ...
            <div class="G_y_l">
				...
				?>		
					<dl>
                        <a class="SC_po" href="#" target="_blank">
    ...
    <!--<div class="tanc_del">
    	<div class="del_box">
            ...
            <div class="del_bun"><a class="sure" href="#" target="_blank">确定</a><input class="false" type="button" value="取消"></div>
        </div>
    </div>-->
    <!--foot start-->   
